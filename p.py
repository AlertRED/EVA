...
owm = pyowm.OWM('65d32d19c914c5ebb376ebb48431c79c',language='ru');
...
def weather_now(text):
    ...
    if text[7:12:1] == 'санкт':
        city = 'Saint Petersburg, AM'
    if text[7:13:1] == 'ереван':
        city = 'Yerevan, AM'
    if text[7:13:1] == 'нальчи':
        city = 'Nalchik, RU'
    if text[7:13:1] == 'чалтыр':
        city = 'Myasnikovskiy rayon, RU'
    ...
    translate_city = {'Rostov-na-Donu': 'Ростов-на-Дону', 'Moscow': 'Москва', 'Saint Petersburg': 'Санкт-Петербург',
                       'Yerevan': 'Ереван', 'Nalchik': 'Нальчик', 'Krym': 'Чалтырь'}
    ...
    try:
        ...
        return 'Извините, прогноз погоды в данное время недоступен.'